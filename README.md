...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,881 | 🐛 107 | 📅 2026-09-02 list thing.
...
* [Appium](https://github.com/appium/appium/blob/master/docs/en/about-appium/intro.md) ⭐ 22,006 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-24 - Appium is an open source, cross-platform test automation tool for native, hybrid and mobile web and desktop apps, tested on simulators (iOS), emulators (Android), and real devices (iOS, Android, Windows, Mac).

## Clients

* [Python](https://github.com/appium/python-client) ⭐ 1,842 | 🐛 23 | 🌐 Python | 📅 2026-09-22
* [Java](https://github.com/appium/java-client) ⭐ 1,282 | 🐛 271 | 🌐 Java | 📅 2026-09-16
* [RobotFramework](https://github.com/jollychang/robotframework-appiumlibrary) ⭐ 429 | 🐛 28 | 🌐 Python | 📅 2026-03-10
* [C# (.NET)](https://github.com/appium/appium-dotnet-driver) ⭐ 399 | 🐛 13 | 🌐 C# | 📅 2026-09-22
