...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,982 | 🐛 106 | 📅 2026-09-02 list thing.
...
* [Appium](https://github.com/appium/appium/blob/master/docs/en/about-appium/intro.md) ⭐ 21,929 | 🐛 54 | 🌐 TypeScript | 📅 2026-09-04 - Appium is an open source, cross-platform test automation tool for native, hybrid and mobile web and desktop apps, tested on simulators (iOS), emulators (Android), and real devices (iOS, Android, Windows, Mac).

## Clients

* [Python](https://github.com/appium/python-client) ⭐ 1,841 | 🐛 24 | 🌐 Python | 📅 2026-09-01
* [Java](https://github.com/appium/java-client) ⭐ 1,281 | 🐛 272 | 🌐 Java | 📅 2026-09-01
* [RobotFramework](https://github.com/jollychang/robotframework-appiumlibrary) ⭐ 429 | 🐛 28 | 🌐 Python | 📅 2026-03-10
* [C# (.NET)](https://github.com/appium/appium-dotnet-driver) ⭐ 398 | 🐛 10 | 🌐 C# | 📅 2026-09-04
* [Ruby](https://github.com/appium/ruby_lib) ⭐ 218 | 🐛 1 | 🌐 Ruby | 📅 2026-08-31
* [Objective C](https://github.com/appium/selenium-objective-c) ⭐ 81 | 🐛 13 | 🌐 Objective-C | 📅 2016-02-03
* [PHP](https://github.com/appium/php-client) ⭐ 71 | 🐛 13 | 🌐 PHP | 📅 2018-09-19
...
* [Appium Workshop Selnium Conf 2016](https://github.com/isonic1/appium-workshop) ⭐ 26 | 🐛 1 | 🌐 HTML | 📅 2018-09-12 - Repo for Appium Workshop at the 2016 Selenium Conference - Justin Ison.

## Cloud and Docker Solutions

* [Appium Docker Images](https://github.com/butomo1989/docker-android) ⭐ 15,820 | 🐛 161 | 🌐 Python | 📅 2026-09-04 - DockerFile for Appium Android.
* [Official Appium Docker Images](https://github.com/appium/appium-docker-android) ⭐ 671 | 🐛 10 | 🌐 Shell | 📅 2026-09-01 - DockerFile for Appium Android Real Devices.
...
* [Parallel Framework Java-Client](https://github.com/saikrishna321/AppiumTestDistribution) ⭐ 1,040 | 🐛 45 | 🌐 Java | 📅 2026-03-23 - Run appium tests in parallel across iOS and Android devices.
* [PageObject Pattern Framework](https://github.com/saikrishna321/PageObjectPatternAppium) ⭐ 187 | 🐛 19 | 🌐 JavaScript | 📅 2023-05-10 - Sample Page Object Pattern Framework to use directly.
* [coteafs-appium](https://github.com/WasiqB/coteafs-appium) ⭐ 148 | 🐛 6 | 🌐 Java | 📅 2022-08-17 - A tester friendly Mobile Automation Framework built on top of Appium which supports testing web and native apps for Android, iOS and Windows real or emulator Mobiles and Tablets.
* [Appium-Native-Crawler](https://github.com/isonic1/Appium-Native-Crawler) ⭐ 55 | 🐛 2 | 🌐 Ruby | 📅 2019-06-30 - Appium Native Crawler CLI - Features include: Screenshots, Performance, Accessibility Detection, Google Translate, Applitools, Monkey Tester.
* [Appium Cucumber Test](https://github.com/priyankshah217/AppiumCucumberTest) ⭐ 37 | 🐛 1 | 🌐 Java | 📅 2021-03-16 - Sample Appium Cucumber Project.
