...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,704 | 🐛 105 | 📅 2026-08-21 list thing.
...
* [Appium](https://github.com/appium/appium/blob/master/docs/en/about-appium/intro.md) ⭐ 21,913 | 🐛 61 | 🌐 TypeScript | 📅 2026-08-31 - Appium is an open source, cross-platform test automation tool for native, hybrid and mobile web and desktop apps, tested on simulators (iOS), emulators (Android), and real devices (iOS, Android, Windows, Mac).

## Clients

* [Python](https://github.com/appium/python-client) ⭐ 1,839 | 🐛 26 | 🌐 Python | 📅 2026-08-31
* [Java](https://github.com/appium/java-client) ⭐ 1,281 | 🐛 272 | 🌐 Java | 📅 2026-08-31
...
* [Appium Docker Images](https://github.com/butomo1989/docker-android) ⭐ 15,797 | 🐛 163 | 🌐 Python | 📅 2026-08-30 - DockerFile for Appium Android.
* [Official Appium Docker Images](https://github.com/appium/appium-docker-android) ⭐ 671 | 🐛 11 | 🌐 Shell | 📅 2026-08-27 - DockerFile for Appium Android Real Devices.
